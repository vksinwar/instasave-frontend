...
function App() {
  ...
  const handleDownload = async () => {
    ...
    try {
      const response = await fetch('https://y0h0i3cq67n5.manus.space/api/video/extract', {
        method: 'POST',
        headers: {
  ...
  const handleVideoDownload = async (formatId) => {
    ...
    try {
      const response = await fetch('https://y0h0i3cq67n5.manus.space/api/video/download', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
